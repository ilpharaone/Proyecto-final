    ...
    public class EmpresaDA
    {
        ...
        public void Insertar(EmpresaEntidad empresaEntidad)
        {
            ...
            try
            {
                ...
                sqlComm.Parameters.Add(new SqlParameter("@IDTEmpresa", empresaEntidad.IDTipoEmpresa));
                sqlComm.Parameters.Add(new SqlParameter("@Empresa", empresaEntidad.Empresa));
                sqlComm.Parameters.Add(new SqlParameter("@Direcion", empresaEntidad.Direccion));
